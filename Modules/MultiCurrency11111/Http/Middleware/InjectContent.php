    ...
    public function handle(Request $request, Closure $next)
    {
        ...
        if ($response instanceof \Illuminate\Http\Response && strpos($response->headers->get('Content-Type'), 'text/html') !== false) {
            ...
            if ($divs->length > 0) {
                ...
                $editPages = ['purchases.edit', 'sells.edit', 'pos.edit'];
                ...
                $showPages = ['purchases.index', 'purchases.show', 'sells.show', 'pos.show'];
                ...
                $purchasePages = ['purchases.create', 'purchases.edit', 'purchases.show', 'purchases.index'];
