    ...
    <div class="col-sm-4" id="settings_multi_currency_exchange_div">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::number('m_exchange_rate', $currency_transaction->exchange_rate ?? null, ['class' => 'form-control', 'placeholder' => __('multicurrency::lang.exchange_rate'), 'step' => 'any', 'readonly' => 'readonly']); !!}
            </div>
        </div>
    </div>
    <div>
