...
class CoaController extends Controller
{
    ...
    function getWalkInCustomer($business_id)
    {
    ...
    function getAllContacts($business_id,$account)
    {
        $contacts = [];
    ...
    function getAllExpenseCategories($business_id)
    {
    ...
    function getAllAccounts($business_id)
    {
        $accounts = [];
    ...
    function getAllUsers($business_id)
    {
        $users = [];
